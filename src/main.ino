...
// === PRIVATE credentials =====
   // STT (slow) - ### INSERT your Deepgram KEY       [optional]   
...
int gl_VOL_INIT =       14;      // Initial Audio volume on Power On / possible values: 0-21 (e.g. start with max. Volume 21) 
...
// --- PCB: SEEED XIAO ESP32-S3 (YOUR exact wiring) ----------------------
#define NO_PIN          -1

#define SD_CS           NO_PIN      // no SD card
#define SD_SCK          NO_PIN
#define SD_MISO         NO_PIN
#define SD_MOSI         NO_PIN

// === I2S Microphone (INMP441) - your wiring ===
#define I2S_WS          2           // WS = D1 = GPIO2
#define I2S_SD          1           // SD = D0 = GPIO1
#define I2S_SCK         3           // SCK = D2 = GPIO3
#define I2S_LR          LOW

// === I2S Amplifier (MAX98357) - your wiring ===
#define pin_I2S_DOUT    4           // DIN = D3 = GPIO4
#define pin_I2S_LRC     5           // LRCLK = D4 = GPIO5
#define pin_I2S_BCLK    6           // BCLK = D5 = GPIO6 

// WARNING: BCLK and mic SCK are both on GPIO3 (D2) → this will NOT work!
// Please re-wire amp BCLK to a free pin, e.g. GPIO7 (D8) or GPIO44.
...
#define pin_TOUCH       NO_PIN      // you have no touch button
...
{   
   ...
   audio_play.elevenlabs_speech( ELEVENLABS_KEY, voice, p_request );
}
